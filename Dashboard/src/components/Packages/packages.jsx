    ...
    <div className="container">
      ...
      <Dialog header={editIndex !== null ? "Edit Package" : "Add Package"} visible={displayDialog} style={{ width: '50vw' }} onHide={() => setDisplayDialog(false)}>
        <div className="fade-in">
          ...
          <Calendar 
            value={startDate} 
            onChange={(e) => { setStartDate(e.value); setErrors(prevErrors => ({ ...prevErrors, startDate: '' })); }} 
          ...
          <Calendar 
            value={endDate} 
            onChange={(e) => { setEndDate(e.value); setErrors(prevErrors => ({ ...prevErrors, endDate: '' })); }} 
      ...
      <Dialog header="Preview Package" visible={previewVisible} style={{ width: '50vw' }} onHide={() => setPreviewVisible(false)}>
        <div className="fade-in">
          ...
          <p><strong>Start Date:</strong> {startDate ? startDate.toLocaleDateString() : 'N/A'}</p>
      ...
      <div className="packages-container">
        {packages.map((pkg, index) => (
          <div key={index} className="package-card">
            ...
            {pkg.endDate && <p><strong>End Date:</strong> {new Date(pkg.endDate).toLocaleDateString()}</p>}
